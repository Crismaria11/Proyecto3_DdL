...
def create_file(final, dfas, parse_line,title):
    output = open(title + ".py", "w+", encoding="utf-8")
    ...
    output.write("            parser.EstadoInicial()\n")
    output.write("            true_list = []\n")
...
if __name__ == "__main__":
    file = open("inputs/ArchivoPruebaMio.atg")
    content = file.read()
    ...
    create_file(final, dfas, parse_ln,"ArchivoPruebaMio")